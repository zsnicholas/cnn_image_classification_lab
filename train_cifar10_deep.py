...
def main():
    ...
    epochs = 15
    best_test_acc = 0.0
    save_path = "checkpoints/best_cifar10_deep_cnn.pth"
    ...
    for epoch in range(epochs):
        ...
        if test_acc > best_test_acc:
            ...
            print(f"发现更好的 Deep CNN 模型，当前最佳 Test Acc: {best_test_acc:.4f}")
    ...
    plot_training_curves(
        ...
        save_path="results/cifar10_deep_cnn_curves.png"
    )
